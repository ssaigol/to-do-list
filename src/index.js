...
import { renderProjectPage, renderHomePage, renderSidebar } from "./modules/render";

import { getProjects } from "./modules/todo-logic";

// import { initDomCache, getCache } from "./modules/dom-cache";

// initDomCache();
// const { dialog } = getCache();
// dialog.showModal();
...
renderProjectPage(projects, "Shopping List");
